...
M7: prepare the public alpha package with guided setup, reversible upgrades/removal, schema migration, a current compatibility matrix, and clean-machine installation checks.
