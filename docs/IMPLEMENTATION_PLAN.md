...
M5: add worktree isolation, dependency scheduling, premium/concurrency dispatch limits, and an integration owner. Keep M4's checkpoint and evidence invariants across parallel workers.
