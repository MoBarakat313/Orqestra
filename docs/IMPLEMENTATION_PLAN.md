...
Use public-alpha feedback and paired benchmark evidence to choose the next milestone. Priorities are the unverified real-runtime recovery and cancellation paths in [COMPATIBILITY.md](COMPATIBILITY.md), clearer natural-language contract authoring inside Codex, and additional runtime adapters only when they can be tested end to end.
